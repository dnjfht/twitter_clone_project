...
const TextInput = styled.input`
  ...
  padding: 40px;
  box-sizing: border-box;
  background: #000 linear-gradient(14deg, #ffdee9 0%, #08a0f0 100%);

  border-radius: 50px;
  border: 1px solid transparent;

  background: linear-gradient(45deg, black, black) border-box; /*3*/
  -webkitmask: /*4*/ linear-gradient(#fff 0 0) padding-box,
