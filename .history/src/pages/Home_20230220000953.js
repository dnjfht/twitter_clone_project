...
const SubmitButton = styled.button`
  ...
  &:hover {
    background-color: rgb(8, 160, 240);
...
const AddPhotoIconWrap = styled.div`
...
const RemovePhotoLabel = styled.label`
  width: 144px;
  height: 40px;
  margin: 0 auto;
...
const RemovePhotoSpan = styled.span`
  color: #08a0f0;
`;
...
const RemovePhotoIconWrap = styled.div`
  transition: all ease 0.3s;
  &:hover {
    transform: rotate(720deg);
  }
    ...
    <HomeWrap>
      <HomeInnerWrap>
        <FormWrap onSubmit={onSubmit}>
          ...
          <AddPhotoLabel for="attach-file">
            <AddPhotoSpan>Add photos</AddPhotoSpan>
            <AddPhotoIconWrap>
              <FontAwesomeIcon
                icon={faPlus}
                style={{ color: "#08a0f0", fontSize: 17, marginTop: 4 }}
              />
            </AddPhotoIconWrap>
          </AddPhotoLabel>
          <AddPhotoInput
          ...
          {attachment && (
            <PreviewImgWrap>
              <PreviewImg src={attachment} alt="preview" />

              <RemovePhotoLabel for="attach-remove-file">
                <RemovePhotoSpan>Remove photos</RemovePhotoSpan>
                <RemovePhotoIconWrap>
                  <FontAwesomeIcon
                    icon={faXmark}
                    style={{ color: "#08a0f0", fontSize: 17, marginTop: 4 }}
