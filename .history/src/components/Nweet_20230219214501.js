...
const DeleteNweetLabel = styled.label``;

const EditNweetLabel = styled.label`
  margin-left: 24px;
`;
...
const DelteIcon = styled.FontAwesomeIcon``;
  ...
  return (
    <NweetsWrap>
      <NweetTopWrap>
        ...
        <NweetTopRight>
          <DeleteNweetLabel for="delete-nweet">
            <Delete
              icon={faTrash}
              style={{ color: "rgba(0,0,0,0.8)", fontSize: 17 }}
            />
          </DeleteNweetLabel>

          <EditNweetLabel for="edit-nweet">
            <FontAwesomeIcon
              icon={faPen}
              style={{
                color: "rgba(0,0,0,0.8)",
      ...
      {isOwner ? (
        <>
          <DeleteNweetButton onClick={onDeleteClick} id="delete-nweet">
            Delete Nweet
          </DeleteNweetButton>
          <EditNweetButton onClick={toggleEditing} id="edit-nweet">
            Edit Nweet
          </EditNweetButton>
        </>
      ) : (
